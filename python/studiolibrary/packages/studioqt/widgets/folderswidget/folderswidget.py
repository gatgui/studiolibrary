#Embedded file name: C:/Users/hovel/Dropbox/packages/studiolibrary/1.23.2/build27/studiolibrary/packages/studioqt\widgets\folderswidget\folderswidget.py
import os
import logging
...
class FoldersWidget(QtWidgets.QTreeView):
    ...
    def showCreateDialog(self, parent = None):
        ...
        :rtype: None
        """
        name, accepted = QtWidgets.QInputDialog.getText(parent, 'Create Folder', 'Name', QtWidgets.QLineEdit.Normal)
        name = name.strip()
